                ...
                for ensemble_size in ensemble_size_list:
                    for epochs in epochs_list:
                        for batch_size in batch_list:
                            for lr in lr_list:
                                train_with_params(seed=seed, ensemble_size=ensemble_size, alpha_init=alpha,
                                                  gamma_init=gamma, num_epochs=epochs, batch_size=batch_size, lr=lr,
                                                  device=device)
